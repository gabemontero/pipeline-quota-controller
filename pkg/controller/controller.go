...
import (
	...
	"github.com/gabemontero/pipeline-quota-controller/pkg/reconciler/clusterresourcequota"
	"github.com/gabemontero/pipeline-quota-controller/pkg/reconciler/k8slimitrange"
	"github.com/gabemontero/pipeline-quota-controller/pkg/reconciler/k8sresourcequota"
	"github.com/gabemontero/pipeline-quota-controller/pkg/reconciler/pipelinerun"
...
func NewManager(cfg *rest.Config, options ctrl.Options) (ctrl.Manager, error) {
	...
	if err = pipelinerun.SetupPRReconcilerWithManager(mgr); err != nil {
		return nil, err
	}
	...
	if err = k8slimitrange.SetupNewReconcilerWithManager(mgr); err != nil {
		return nil, err
	}
